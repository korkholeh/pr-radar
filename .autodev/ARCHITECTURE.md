...
| `ai_detection` | `DetectionRule`, `AISignal`, the twelve detectors, the PR-template disclosure parser, `ai_status` resolution | Detection rules are data the admin edits at runtime; they must be re-runnable over stored PRs without touching GitHub |
