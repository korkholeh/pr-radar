...
| `ai_detection` | `DetectionRule`, `AISignal`, twelve detectors, the PR-template disclosure parser, `ai_status` resolution | `detectors.py`, `disclosure.py`, `rules.py`, `services.py` |
