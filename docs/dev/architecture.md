...
| Alpine.js in the front-end stack | Not used — htmx only, plus seven hand-written scripts (`theme.js`, `charts.js`, `formatting.js`, `filters.js`, `datepicker.js`, `tagselect.js`, `info_tip.js`) | Nothing in the built UI needed it; adding an unused dependency to the page weight would have been cost without benefit |
