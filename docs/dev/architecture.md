...
| `ai_detection` | `DetectionRule`, `SignalRule`, `AISignal`, twelve detectors, six structural kinds, the PR-template disclosure parser, `ai_status` resolution | `detectors.py`, `structural.py`, `evidence.py`, `disclosure.py`, `rules.py`, `services.py` |
